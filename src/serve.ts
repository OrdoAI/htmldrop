...
var IC_COLLAPSE='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 6l6 6-6 6"/><line x1="5" y1="5" x2="5" y2="19"/></svg>';
...
+'.rail{position:fixed;top:0;right:0;bottom:0;width:344px;max-width:86vw;background:#fff;border-left:1px solid #e9eaec;box-shadow:-4px 0 24px rgba(31,35,41,.06);display:flex;flex-direction:column;z-index:2147483646;font:400 14px/1.6 -apple-system,"PingFang SC",system-ui,sans-serif;color:#1f2329}.rail[hidden]{display:none}.rh{display:flex;align-items:center;padding:13px 8px 13px 16px;border-bottom:1px solid #e9eaec;flex:0 0 auto}.nav{display:inline-flex;border:1px solid rgba(31,35,41,.12);border-radius:7px;overflow:hidden}.nav .navb{border:0;background:#fff;width:26px;height:26px;display:grid;place-items:center;color:#646a73;cursor:pointer}.nav .navb+.navb{border-left:1px solid rgba(31,35,41,.12)}.nav .navb:hover:not(:disabled){background:#f2f3f5;color:#1f2329}.nav .navb:disabled{color:#c9cdd4;cursor:default}.nav .navb svg{width:15px;height:15px;stroke:currentColor;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.rh .grow{flex:1}.copybtn{display:inline-flex;align-items:center;gap:5px;border:1px solid rgba(31,35,41,.12);background:#fff;border-radius:8px;padding:6px 9px;font:600 12px/1 -apple-system,system-ui,sans-serif;color:#3c4257;cursor:pointer;white-space:nowrap;margin-right:4px}.copybtn[hidden]{display:none}.copybtn:hover{background:#f7f8fa}.copybtn svg{width:13px;height:13px;fill:currentColor}.ib{border:0;background:transparent;cursor:pointer;color:#646a73;width:30px;height:30px;border-radius:6px;display:grid;place-items:center}.ib:hover{background:#f2f3f5;color:#1f2329}.ib svg{width:18px;height:18px}'
+'.ident{padding:8px 12px;border-bottom:1px solid #e9eaec;flex:0 0 auto}.identrow{display:flex;align-items:center;gap:8px}.identrow[hidden]{display:none}.identav{flex:0 0 auto;width:26px;height:26px;border-radius:50%;overflow:hidden}.identav svg{width:100%;height:100%;display:block}.name{flex:1;min-width:0;box-sizing:border-box;border:1px solid rgba(31,35,41,.12);border-radius:7px;padding:6px 9px;font:inherit;font-size:13px;background:#fafbfc}.name:focus{outline:0;border-color:#3370ff;background:#fff}.name.req{border-color:#f5a623;background:#fff8ec}.name.req::placeholder{color:#d98c00}.identset{display:flex;align-items:center;gap:8px;font-size:13px;color:#646a73}.identset[hidden]{display:none}.identset .who{font-weight:600;color:#1f2329;max-width:150px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.identset .editbtn{border:0;background:transparent;color:#3370ff;cursor:pointer;font:inherit;font-size:13px;padding:0 2px}.identset .editbtn:hover{text-decoration:underline}.list{flex:1 1 auto;overflow-y:auto;padding:12px}'
...
+'.acts{position:absolute;top:9px;right:10px;display:flex;align-items:center;gap:1px;background:#fff;border:1px solid rgba(31,35,41,.12);border-radius:7px;padding:2px;box-shadow:0 3px 12px rgba(31,35,41,.12);opacity:0;transition:.12s;pointer-events:none}.cc:hover .acts,.cc.active .acts{opacity:1;pointer-events:auto}.acts button{width:25px;height:25px;border:0;background:transparent;cursor:pointer;color:#646a73;border-radius:5px;display:grid;place-items:center}.acts button:hover{background:#f2f3f5;color:#1f2329}.acts button:disabled{color:#c9cdd4;cursor:default}.acts button:disabled:hover{background:transparent;color:#c9cdd4}.acts .res:hover{color:#3370ff}.acts .lnk:hover{color:#3370ff}.acts .copy:hover{color:#3370ff}.acts button svg{width:15px;height:15px;stroke:currentColor;fill:none;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.acts .copy svg{stroke:none;fill:currentColor;width:14px;height:14px}.acts .del:hover{color:#e5484d}.acts .del.armed{background:#e5484d;color:#fff}.acts .del.armed:hover{background:#d13b40;color:#fff}.cc.confirming .acts{opacity:1;pointer-events:auto}'
...
+'.reply{margin-top:11px}.reply .rfaint{display:none;font-size:13px;color:#a8abb2;cursor:text;padding:3px 1px}.reply.collapsed .rfaint{display:block}.reply .rbox{display:flex;gap:6px}.reply.collapsed .rbox{display:none}.reply .rin{flex:1;min-width:0;box-sizing:border-box;border:1px solid #3370ff;border-radius:8px;padding:7px 9px;font:inherit;font-size:13px;background:#fff}.reply .rin:focus{outline:0}.reply .send{flex:0 0 auto;border:0;background:#3370ff;color:#fff;border-radius:8px;padding:0 14px;font:500 12.5px/1;cursor:pointer}'
...
+'<aside id="hd-rail" class="rail" hidden><div class="rh"><span class="nav"><button id="hd-prev" class="navb" title="上一条评论" aria-label="上一条评论">'+IC_UP+'</button><button id="hd-next" class="navb" title="下一条评论" aria-label="下一条评论">'+IC_DOWN+'</button></span><span class="grow"></span><button id="hd-copy" class="copybtn" title="复制全文 + 全部评论，给 LLM" hidden><span class="ico">'+IC_COPY+'</span><span class="lbl">Copy for LLM</span></button><button id="hd-collapse" class="ib" title="收起" aria-label="收起">'+IC_COLLAPSE+'</button></div>'
+'<div class="ident"><div id="hd-identrow" class="identrow"><span id="hd-identav" class="identav"></span><input id="hd-name" class="name" placeholder="你的名字（必填，评论时显示）" maxlength="80"></div><div id="hd-identset" class="identset" hidden><span id="hd-identav2" class="identav"></span>以 <span id="hd-identname" class="who"></span> 评论<button id="hd-identedit" class="editbtn">· 改</button></div></div>'
...
function onMouseUp(){setTimeout(function(){var s=window.getSelection();if(s&&!s.isCollapsed&&s.rangeCount){var r=s.getRangeAt(0);if(document.body.contains(r.commonAncestorContainer)){var rect=r.getBoundingClientRect();if(rect.width||rect.height){selRef.style.top=(window.scrollY+rect.top-44)+"px";selRef.style.left=(window.scrollX+rect.left+rect.width/2-34)+"px";selRef._range=r.cloneRange();selRef.hidden=false;return;}}}selRef.hidden=true;},0);}
